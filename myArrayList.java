...
/**
 * MyArrayList class, declares an intitially sized ArrayList of objects with a
 * growth policy of 20% to be utilized in add, remove, and contains methods.
 * 
 * @author Jonah Kastelic
 * @param <Fraction> Fraction type object
...
public class MyArrayList<T> {
	...
	/*
	 * Gabrielle Akers September 13, 2023
	 */
